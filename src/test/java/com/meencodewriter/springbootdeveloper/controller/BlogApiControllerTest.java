...
class BlogApiControllerTest {
    ...
    public void updateArticle() throws Exception {
        ...
        Article modifiedArticle = blogRepository.findById(article.getId()).get();

        assertThat(modifiedArticle.getTitle()).isEqualTo(newTitle);
        assertThat(modifiedArticle.getContent()).isEqualTo(newContent);
